...
class alternatif_model extends Model
{
    ...
    {
        $dataquery1=$this->db->query("select max(C1) as maxminK1, max(C2) as maxminK2, max(C3) as maxminK3, max(C4) as maxminK4, max(C5) as maxminK5, max(C6) as maxminK6 from data_alternatif");
