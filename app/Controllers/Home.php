...
class Home extends BaseController
{
    ...
    public function edit_kriteria(String $id)
    {
        ...
        $tabelju = "kriteria";
        $ju->prosesEdit_kriteria($tabelju, $data, $where);
        return redirect()->to(site_url('home/view_kriteria'));
    }
    ...
    {
        $model = new kriteria_model();
        $dataj = $model->tampildata();
        $data = array('dataa' => $dataj);
    ...
    public function simpan_bobot()
    {
        ...
        if ($isDuplicate) {
            $session = session();
            $session->setFlashdata('alert', 'Nama bobot sudah ada');

            return redirect()->to(site_url('home/input_bobot'));
        }
    ...
    public function edit_bobot(String $id)
    {
        ...
        $tabelk = "bobot";
        $um->prosesEdit_bobot($tabelk, $data, $where);
        return redirect()->to(site_url('home/view_bobot'));
    }
    ...
    public function simpan_alt()
    {
        ...
        return redirect()->to(site_url(('Home/view_alt')));
    }
