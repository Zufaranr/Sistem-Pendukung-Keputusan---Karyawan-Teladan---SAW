    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item <?php if (
                              in_array($activeMenu, ['mhs']) || in_array($activeMenu, ['ju']) ||
                              in_array($activeMenu, ['umkm']) || in_array($activeMenu, ['kriteria']) || in_array($activeMenu, ['bobot']) || in_array($activeMenu, ['alternatif'])
                            ) echo "menu-open" ?>">
