                    ...
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            <form action="<?= site_url('home/edit_alt/' . $row->id_alternatif) ?>" method="post">
                                ...
                                <label for="">C4</label>
                                <input type="number" name="nilai4" class="form-control" value="<?= $row->C4 ?>"><br>

                                <label for="">C5</label>
                                <input type="number" name="nilai5" class="form-control" value="<?= $row->C5 ?>"><br>

                                <label for="">C6</label>
                                <input type="number" name="nilai6" class="form-control" value="<?= $row->C6 ?>"><br>


                                <button class="btn btn-success" onclick="location.href='<?= site_url('home/view_alt') ?>'">
                                    Update
                                </button>
                            </form>
